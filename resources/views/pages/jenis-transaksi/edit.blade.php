...
<div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item">Edit Jenis Transaksi</div>
</div>
</div>
...
<div class="row">
    <div class="col-8 ">
        <div class="card">
            <form action="{{ route('jenis-transaksi.update', $jenis->id) }}" method="post"
                enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-header">
                    <h4>Form Edit Jenis Transaksi</h4>
                </div>
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text"
                            ...
                            id="jenis" name="jenis" autofocus="on" value="{{ old('jenis', $jenis->jenis ?? '') }}"
                            required>
                        @error('jenis')
