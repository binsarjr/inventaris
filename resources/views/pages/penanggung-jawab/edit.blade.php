        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Edit Penanggung Jawab</div>
                </div>
            </div>

            <div class="section-body">
                {{-- <h2 class="section-title">Edit Penanggung Jawab</h2>
                ...
                <div class="row">
                    <div class="col-8 ">
                        <div class="card">
                            <form action="{{ route('penanggung-jawab.update', $penanggungJawab->id) }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="card-header">
                                    <h4>Form Edit Penanggung Jawab</h4>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('nama_lengkap', $penanggungJawab->nama_lengkap ?? '') }}"
                                            required>
                                        @error('nama_lengkap')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="tel"
                                                ...
                                                name="no_hp" value="{{ old('no_hp', $penanggungJawab->no_hp ?? '') }}"
                                                id="no_hp" pattern="[0-9]*">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea data-height="75"
                                            ...
                                            id="alamat" name="alamat" required>{{ old('alamat', $penanggungJawab->alamat ?? '') }}</textarea>
                                        @error('alamat')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        @if ($penanggungJawab->foto)
                                            <div class="row">
                                                <img src="{{ asset('img/penanggung-jawab/' . $penanggungJawab->foto) }}"
                                                    class="img-preview mb-3 col-sm-3 d-block"
                                                    data-src="{{ asset('img/penanggung-jawab/' . $penanggungJawab->foto) }}">
                                            </div>
                                        @else
                                            <div class="row">
