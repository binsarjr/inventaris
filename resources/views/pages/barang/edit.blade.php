        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">Update Barang</div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <form action="{{ route('barang.update', $barang->id) }}" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="deskripsi" autocomplete="off" style="height: 100px;" class="form-control" id="validationTextarea"
                                            placeholder="" required>{{ $barang->deskripsi }}</textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" autocomplete="off"
                                                    ...
                                                    id="stok" name="stok" autofocus value="{{ $barang->stok }}"
                                                    required>
                                                @error('stok')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            @if ($barang->foto)
                                                <div class="row">
                                                    <img src="{{ asset('img/barang/' . $barang->foto) }}"
                                                        class="img-preview mb-3 col-sm-3 d-block"
                                                        data-src="{{ asset('img/barang/' . $barang->foto) }}">
                                                </div>
                                            @else
                                                <div class="row">
                                                    <img class="img-preview mb-3 col-sm-3 d-block">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="file"
                                                    ...
                                                    name="foto" accept="image/*" id="foto"
                                ...
                                <div class="card-footer text-right">
                                    ...
                                    <a href="{{ route('barang.index') }}" class="btn btn-primary mr-1 ml-1"
